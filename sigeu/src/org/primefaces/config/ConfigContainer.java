...
/**
 * O Primefaces exige uma implementação de JSF 2.2 ou superior, mas verifica
 * somente as versões 2.1 e 2.2 (considerando inválidas as versões posteriores).
 * Essa classe contorna essa validação fazendo o método isAtLeastJSF22()
 * retornar sempre true.
 * 
...
public class ConfigContainer {
	...
	if (available) {
	    ...
	    // If any Exception occurs here, we assume that Bean Validation is not
	    // available.
