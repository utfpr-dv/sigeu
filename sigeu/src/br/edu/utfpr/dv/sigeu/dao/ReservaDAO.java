...
public class ReservaDAO extends HibernateDAO<Reserva> {
    ...
    public List<Reserva> pesquisaReserva(Campus campus, StatusReserva status, Date data, Date horaI, Date horaF, TipoReserva tipoReserva,
	    CategoriaItemReserva categoria, ItemReserva item, String nomeUsuario) {
	return this.pesquisaReserva(campus, status, data, data, horaI, horaF, tipoReserva, categoria, item, nomeUsuario);
    }

    public List<Reserva> pesquisaReserva(Campus campus, StatusReserva status, Date data, Date data2, Date horaI, Date horaF, TipoReserva tipoReserva,
	    CategoriaItemReserva categoria, ItemReserva item, String nomeUsuario) {
	return this.pesquisaReserva(campus, status, data, data2, horaI, horaF, tipoReserva, categoria, item, nomeUsuario, null, false);
    }
     ...
     */
    public List<Reserva> pesquisaReserva(Campus campus, StatusReserva status, Date data, Date data2, Date horaI, Date horaF, TipoReserva tipoReserva,
	    CategoriaItemReserva categoria, ItemReserva item, String nomeUsuario, String motivo, boolean incluiItemDesativado) {
    ...
    public List<Reserva> pesquisaReservaDoUsuario(Campus campus, StatusReserva status, Pessoa pessoa, Date dataInicial, Date dataFinal,
    ...
    public List<Reserva> pesquisaReserva(Campus campus, StatusReserva status, Date data, Date horaInicio, Date horaFim, CategoriaItemReserva categoria,
	    ItemReserva item) {
	StringBuilder hql = new StringBuilder();
	hql.append("SELECT o ");
	hql.append("FROM Reserva o JOIN o.idCampus c JOIN o.idItemReserva i JOIN i.idCategoria c ");
