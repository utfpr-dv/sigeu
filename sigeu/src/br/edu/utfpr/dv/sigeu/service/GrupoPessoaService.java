...
public class GrupoPessoaService {
     ...
     * 
     * @param trans  Transação de controle. Este método foi projetado para ser
     ...
     */
    public void atualizaGrupos(Transaction trans, Pessoa pessoa, List<GrupoPessoa> grupos) throws Exception {
	// try {
