...
public class EmailService {
    ...
    public void enviaEmailConfirmacao(Campus campus, Reserva reserva, String[] emails) throws Exception {
	List<Reserva> reservas = new ArrayList<Reserva>();
	reservas.add(reserva);
	enviaEmailConfirmacao(campus, reservas, emails);
    }
     ...
     * @throws Exception
     */
    public void enviaEmailConfirmacao(Campus campus, List<Reserva> listaReserva, String[] emails) throws Exception {
     ...
     * @param itemReserva
     */
    public void enviaEmailAutorizador(Campus campus, Pessoa autorizador, ItemReserva itemReserva) {
	try {
    ...
    public String[] getEmailFromReservas(List<Reserva> listReservas) {
    ...
    public String[] getEmailFromReserva(Reserva reserva) {
