...
public class LdapServerBean extends JavaBean {
    ...
    /**
     * Cria uma nova ldapServer se o ID for nulo ou 0 ou altera uma ldapServer já
     * gravada no banco de dados se ela já existir
     */
    public void gravar() {
	boolean novo = (ldapServer.getIdServer() == null);

	if (campus == null || instituicao == null || campus.getIdCampus() == null
		|| instituicao.getIdInstituicao() == null) {
		...
		addInfoMessage("Gravar",
			"LdapServer " + label + " " + (novo ? "criado" : "alterado") + " com sucesso!");
